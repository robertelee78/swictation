...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   Mean: {:.6}", samples_24k.iter().sum::<f32>() / samples_24k.len() as f32);
    ...
    println!("   Mean: {:.6}", samples_16k.iter().sum::<f32>() / samples_16k.len() as f32);
    ...
    println!("\n📊 Feature comparison:");
    println!("   Frames difference: {}", features_24k.nrows() as i32 - features_16k.nrows() as i32);
