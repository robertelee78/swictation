...
# socket_path is auto-detected per platform (do not hardcode)
# Linux: $XDG_RUNTIME_DIR/swictation.sock or ~/.local/share/swictation/swictation.sock
  ...
  if (isWayland) {
    ...
    if (isGnome) {
      ...
      if (isSway) {
        ...
        log('cyan', '  bindsym $mod+Shift+d exec sh -c \'echo "{\\"action\\": \\"toggle\\"}" | nc -U ${XDG_RUNTIME_DIR:-$HOME/.local/share/swictation}/swictation.sock\'');
      }
    } else {
