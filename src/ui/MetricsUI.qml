                        ...
                        ColumnLayout {
                            ...
                            GridLayout {
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        text: (typeof historyTab.lifetimeStats !== 'undefined' ? historyTab.lifetimeStats.total_words : 0) || 0
                                        color: "#a9b1d6"
                                        font.bold: true
                                        font.pixelSize: 13
                                    }
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        text: (typeof historyTab.lifetimeStats !== 'undefined' ? historyTab.lifetimeStats.total_sessions : 0) || 0
                                        color: "#a9b1d6"
                                        font.bold: true
                                        font.pixelSize: 13
                                    }
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        text: Math.round((typeof historyTab.lifetimeStats !== 'undefined' ? historyTab.lifetimeStats.avg_wpm : 0) || 0)
                                        color: "#a9b1d6"
                                        font.bold: true
                                        font.pixelSize: 13
                                    }
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        text: (((typeof historyTab.lifetimeStats !== 'undefined' ? historyTab.lifetimeStats.time_saved_minutes : 0) || 0) / 60).toFixed(1) + "h"
                                        color: "#a9b1d6"
                                        font.bold: true
                                        font.pixelSize: 13
                                    }
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        text: Math.round((typeof historyTab.lifetimeStats !== 'undefined' ? historyTab.lifetimeStats.best_wpm_value : 0) || 0)
                                        color: "#a9b1d6"
                                        font.bold: true
                                        font.pixelSize: 13
                                    }
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        text: Math.round((typeof historyTab.lifetimeStats !== 'undefined' ? historyTab.lifetimeStats.lowest_latency_ms : 0) || 0) + "ms"
                                        color: "#a9b1d6"
                                        font.bold: true
                                        font.pixelSize: 13
                                    }
